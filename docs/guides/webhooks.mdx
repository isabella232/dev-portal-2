...
Vertex signs webhook events it sends to your endpoints and includes a signature in each event's `x-vertex-signature` header allowing you to verify that Vertex sent the events.
