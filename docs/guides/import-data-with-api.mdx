...
See our [supported file formats](./supported-file-formats.mdx). If you do not have 3D data handy, you can download [`vertex-valve.jt`](https://vertex-public-binaries.s3-us-west-2.amazonaws.com/vertex-valve.jt) to follow along. To create files in one of these formats, `POST` to the [createFile](https://docs.vertexvis.com/#a8f05429-036c-45b8-89ef-6bd3aa14a7fe) API.
